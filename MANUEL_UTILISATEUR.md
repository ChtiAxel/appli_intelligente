...
> 📷 **[Emplacement Capture d'Écran 1]**  
> *Description : Capture du formulaire d'inscription (Sign Up) avec les champs Prénom, Nom, Mot de passe et le bouton « S'inscrire ».*
...
1. Sur le formulaire de connexion (**Sign In**), saisissez :
   ...
   - Votre **Nom** (ex. : *Dupont*).
   - Votre **Mot de passe**.
2. Cliquez sur le bouton bleu **« Se connecter »**.
3. Vous êtes automatiquement redirigé vers votre espace personnel.

> 📷 **[Emplacement Capture d'Écran 2]**  
> *Description : Capture du formulaire de connexion (Sign In) avec les champs Prénom, Nom et Mot de passe.*
...
2. **Modifier ses informations :**
   ...
   - Cliquez sur le bouton vert **« Enregistrer »** pour valider les modifications.

> 📷 **[Emplacement Capture d'Écran 3]**  
> *Description : Capture de la page de profil affichant l'avatar, les informations de l'utilisateur et les boutons « Modifier le profil » et « Déconnexion ».*
...
2. Saisissez votre question en français courant (voir nos conseils dans la section suivante).
3. Validez en appuyant sur la touche **Entrée** de votre clavier ou en cliquant sur le bouton **« Envoyer »**.
4. L'assistant analyse votre demande, consulte la base d'informations et vous répond en quelques instants.

> 📷 **[Emplacement Capture d'Écran 4]**  
> *Description : Capture de l'écran de discussion avec une question posée dans le champ de saisie et la réponse synthétique affichée dans la bulle de chat.*
...
### L'assistant indique ne pas avoir compris ma question ou ne trouve aucun résultat.
> **Solution :** Essayez de reformuler votre phrase en utilisant des termes plus simples (par exemple en précisant le nom exact d'une matière ou en écrivant « Travaux Dirigés » au lieu d'abréviations ambiguës).

### La réponse semble incomplète ou ne correspond pas à ce que j'attendais.
> **Solution :** L'assistant base ses réponses exclusivement sur les données enregistrées dans la base de l'établissement. Si une information n'a pas encore été saisie pour l'année scolaire en cours, elle ne pourra pas être devinée. N'hésitez pas à préciser l'année scolaire souhaitée (ex. : *« pour l'année 2024-2025 »*).

### J'ai oublié mon identifiant de connexion.
> **Solution :** Votre identifiant correspond à la structure `nom.prenom` saisie lors de votre enregistrement (en minuscules). En cas de doute, contactez le support informatique.

### Que faire si un message d'erreur s'affiche lors de la connexion ?
> **Solution :** Vérifiez que vous avez correctement saisi votre mot de passe en respectant les majuscules et minuscules. Si le problème persiste, rafraîchissez la page (touche `F5`).
...
* **Disponibilité :** Du lundi au vendredi, de 8h30 à 17h30
